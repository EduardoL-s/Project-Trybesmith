...
function usernameBodyValidations(req: Request, res: Response, next: NextFunction) {
...
function vocationBodyValidations(req: Request, res: Response, next: NextFunction) {
...
function levelBodyValidations(req: Request, res: Response, next: NextFunction) {
...
function passwordBodyValidations(req: Request, res: Response, next: NextFunction) {
